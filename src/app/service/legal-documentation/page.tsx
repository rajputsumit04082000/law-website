...
export const metadata: Metadata = {
  ...
  description:
    "Expert legal documentation services in Meerut, Ghaziabad, Noida & NCR. Prime Legal Service provides professional drafting of contracts, agreements, affidavits, MOUs, sale deeds, power of attorney, wills, and all types of legal documents for individuals and businesses across Meerut and Delhi NCR.",
};
