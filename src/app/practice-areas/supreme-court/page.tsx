...
export const metadata: Metadata = {
  title: "Supreme Court Lawyer | Sandhya Gupta & Associates",
  description: "Expert legal services for Supreme Court Lawyer in Delhi.",
};
            ...
            <div className="lg:col-span-8">
              <div className="relative h-[220px] sm:h-[320px] md:h-[420px] lg:h-[450px] rounded-xl overflow-hidden mb-8">
                <img 
                  ...
                  alt="Supreme Court Lawyer" 
                  className="w-full h-full object-cover"
                />
              </div>

              <h2 className="font-heading text-2xl sm:text-3xl font-bold text-[#0b1120] mb-5">Supreme Court Lawyer</h2>
              ...
              <h3 className="font-heading text-xl sm:text-2xl md:text-[28px] font-bold text-[#0b1120] mt-10 mb-4">
                Our Supreme Court Lawyer Services
              </h3>
