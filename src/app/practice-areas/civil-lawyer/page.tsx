...
export const metadata: Metadata = {
  title: "Civil Lawyer | Sandhya Gupta & Associates",
  description: "Expert legal services for Civil Lawyer in Delhi.",
};
        ...
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-10">
            ...
            <div className="lg:col-span-8">
              ...
              <h2 className="font-heading text-2xl sm:text-3xl font-bold text-[#0b1120] mb-5">Civil Lawyer</h2>
